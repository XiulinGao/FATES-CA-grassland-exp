...
```{r,label="add-time-hlm1dvar",message=FALSE,results='hide'}
...
cor_survi   = survi_all[c(7,11:15, 17:20,22:33,36:39)] 

cor_allens   = all_mmean                            %>% 
               filter(month==4)                     %>% 
               left_join(param_tbl,by="ens_label")  
cor_allens  = cor_allens[c(7,11:15, 17:20,22:33,36:39)]
...
png(file=file.path(plot_main,"correlation-all.png"),
...
png(file=file.path(plot_main,"correlation-survi.png"),
width=11,height=8,units="in",res=600)
