...
cheyenne)
   ...
   export PERM_PATH="/glade/work/user"
   export TEMP_PATH="/glade/scratch/user"
...
prm_settings=("fates_allom_amode                      1         1"
              ...
              "fates_frag_seed_decay_rate             1         0"
              "fates_mort_hf_sm_threshold             1         0.5"
...
export RSCRIPT="/glade/work/user/conda-envs/py3.9/bin/Rscript"
