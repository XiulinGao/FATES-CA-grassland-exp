...
This scripts reformat WRF down-scaled 9km climate driver for western US to 
CLM readable forcing files. Data is subset to only cover CA region for year 1981-2020. 
...
met_all <- met_all %>% group_by(XLONG,XLAT) %>% 
...
dt <- mean(diff(unique(met_all$time))) 
...
```{r,label="create-monthly-forcing"}
